...
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA" -C mychannel -n basic --peerAddresses localhost:7051 --tlsRootCertFiles "$ORG1_TLS" --peerAddresses localhost:9051 --tlsRootCertFiles "$ORG2_TLS" -c '{"function":"CreateAsset","Args":["SHIP001","Electronics","100","Carrier-Transit","75000","In-Transit"]}' > /dev/null 2>&1
sleep 1
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA" -C mychannel -n basic --peerAddresses localhost:7051 --tlsRootCertFiles "$ORG1_TLS" --peerAddresses localhost:9051 --tlsRootCertFiles "$ORG2_TLS" -c '{"function":"CreateAsset","Args":["SHIP002","Pharmaceuticals","50","Customs-Rotterdam-Transit","45000","In-Transit"]}' > /dev/null 2>&1
sleep 1
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA" -C mychannel -n basic --peerAddresses localhost:7051 --tlsRootCertFiles "$ORG1_TLS" --peerAddresses localhost:9051 --tlsRootCertFiles "$ORG2_TLS" -c '{"function":"CreateAsset","Args":["SHIP003","Cold Chain","15","Warehouse","125000","Delivered"]}' > /dev/null 2>&1
sleep 1
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA" -C mychannel -n basic --peerAddresses localhost:7051 --tlsRootCertFiles "$ORG1_TLS" --peerAddresses localhost:9051 --tlsRootCertFiles "$ORG2_TLS" -c '{"function":"CreateAsset","Args":["SHIP004","Industrial","200","Manufacturer","32000","Delivered"]}' > /dev/null 2>&1
sleep 1
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA" -C mychannel -n basic --peerAddresses localhost:7051 --tlsRootCertFiles "$ORG1_TLS" --peerAddresses localhost:9051 --tlsRootCertFiles "$ORG2_TLS" -c '{"function":"CreateAsset","Args":["SHIP005","Documents","5","Disputed","8000","DISPUTED"]}' > /dev/null 2>&1
sleep 1
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA" -C mychannel -n basic --peerAddresses localhost:7051 --tlsRootCertFiles "$ORG1_TLS" --peerAddresses localhost:9051 --tlsRootCertFiles "$ORG2_TLS" -c '{"function":"CreateAsset","Args":["SHIP006","Textiles","300","Retailer","18000","Delivered"]}' > /dev/null 2>&1
sleep 1
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA" -C mychannel -n basic --peerAddresses localhost:7051 --tlsRootCertFiles "$ORG1_TLS" --peerAddresses localhost:9051 --tlsRootCertFiles "$ORG2_TLS" -c '{"function":"CreateAsset","Args":["SHIP007","Electronics","80","Carrier-Transit","95000","In-Transit"]}' > /dev/null 2>&1
sleep 1
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA" -C mychannel -n basic --peerAddresses localhost:7051 --tlsRootCertFiles "$ORG1_TLS" --peerAddresses localhost:9051 --tlsRootCertFiles "$ORG2_TLS" -c '{"function":"CreateAsset","Args":["SHIP008","Pharmaceuticals","25","Warehouse","210000","Delivered"]}' > /dev/null 2>&1
sleep 1
